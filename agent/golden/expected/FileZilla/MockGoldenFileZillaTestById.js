...
class MockGoldenFileZillaPageById {
    ...
    // ════════════════════════════════════════════════════════════
    async click2() {
        await _clickScoped('사이트 관리자', '~-31982', false, 0);
    }
    ...
    async click4() {
        await _clickScoped('사이트 관리자', '~-31979', false, 0);
    }

    async click5() {
        await _clickScoped('사이트 관리자', '~-31983', false, 0);
    }
    ...
    async click9() {
        await _clickScoped('사이트 관리자', '//Edit[@AutomationId="5999" and @Name="기본 로컬 디렉터리(L):"]', false, 0);
    }
    ...
    async click11() {
        await _clickScoped('사이트 관리자', '//Edit[@AutomationId="5999" and @Name="기본 원격 디렉터리(E):"]', false, 0);
    }
    ...
    async click15() {
        await _clickScoped('사이트 관리자', '~5101', false, 0);
    }
...
async function run() {
    ...
    console.log(`[session] Root session ${_rootSid} ready`);
        ...
        const page = new MockGoldenFileZillaPageById();

...
class MockGoldenFileZillaPageByClass {
    ...
    async click9() {
        await _clickScoped('사이트 관리자', '//Edit[@ClassName="Edit" and @Name="기본 로컬 디렉터리(L):"]');
    }
    ...
    async click11() {
        await _clickScoped('사이트 관리자', '//Edit[@ClassName="Edit" and @Name="기본 원격 디렉터리(E):"]');
    }
    ...
    async click13() {
        await _clickScoped('사이트 관리자', '~-31777');
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click18() {
        await _clickScoped('FileZilla', '~-31824');
    }
}

...
class MockGoldenFileZillaPageByClass {
    ...
    // ════════════════════════════════════════════════════════════
    async click1() {
        osExpandCollapse(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"파일(F)"}, "사이트 관리자(S)...\tCtrl+S", 0, 8);
    }
    ...
    async click8() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"고급"}, null, 45, null, "사이트 관리자");
    }
    ...
    async click16() {
        ...
        const _expHwnd16 = _expHs16.find(h => h === osForegroundHwnd()) || _expHs16[0] || _hwndCache[_mainTitleFrag];
        osExpandCollapse(_expHwnd16, {"automationId":"","className":"","name":"편집(E)"}, null, null, null);
    }

    async click17() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":""}, null, null, null, "Desktop Automation Code Generator - Chrome", false, true);
    }

...
class MockGoldenHeidiSQLPageByClass {
    ...
    // ════════════════════════════════════════════════════════════
    async click1() {
        osExpandCollapse(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":""}, null, 0, 6);
    }
    ...
    async click3() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"SQL"}, null, 61, null, "환경 설정");
    }

    async click4() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"그리드 서식 설정"}, null, 61, null, "환경 설정");
    }

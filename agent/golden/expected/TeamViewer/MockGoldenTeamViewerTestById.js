...
class MockGoldenTeamViewerPageById {
    ...
    // ════════════════════════════════════════════════════════════
    async click9() {
        await _clickScoped('빠른 연결 허용', '~1125', false, 0);
    }
    ...
    async click11() {
        await _clickScoped('빠른 연결 허용', '~1126', false, 0);
    }
    ...
    async click13() {
        await _clickScoped('빠른 연결 허용', '//Window[@Name="빠른 연결 허용"]', false, 0);
    }

    async click14() {
        await _clickScoped('빠른 연결 허용', '~2', false, 0);
    }
...
async function run() {
    ...
    console.log(`[session] Root session ${_rootSid} ready`);
        ...
        const page = new MockGoldenTeamViewerPageById();

...
class MockGoldenTeamViewerPageByClass {
    ...
    // ════════════════════════════════════════════════════════════
    async click1() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"ID를 복사하세요"});
    }

    async click2() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"비밀번호를 복사하세요"});
    }

    async click3() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"비밀번호를 새로고침하세요"});
    }

    async click4() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"세션 코드"});
    }
    ...
    async click6() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"Windows와 함께 TeamViewer 시작"});
    }
    ...
    async click16() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"TeamViewer에 로그인"}, null, 587, null, "TeamViewer");
    }

    async click17() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"email-field","className":"","name":""}, null, 281, null, "TeamViewer");
    }
    ...
    async click21() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"TeamViewer에 로그인"}, null, 610, null, "TeamViewer");
    }

    async click22() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"email-field","className":"","name":""}, null, 286, null, "TeamViewer");
    }
    ...
    async click24() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"계속"}, null, 353, null, "TeamViewer");
    }
}

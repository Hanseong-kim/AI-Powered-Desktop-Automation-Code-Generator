...
class MockGoldenTeamViewerPageByClass {
    ...
    // ════════════════════════════════════════════════════════════
    async click8() {
        await _clickScoped('빠른 연결 허용', '//Text[@Name="이 장치에 Easy Access 권한 부여"]');
    }
    ...
    async click13() {
        await _clickScoped('빠른 연결 허용', '//Window[@ClassName="#32770" and @Name="빠른 연결 허용"]');
    }

    async click14() {
        await _clickScoped('빠른 연결 허용', '//Button[@ClassName="Button" and @Name="취소"]');
    }

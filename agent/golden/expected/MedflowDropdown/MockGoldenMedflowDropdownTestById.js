...
class MockGoldenMedflowDropdownPageById {
    ...
    // ════════════════════════════════════════════════════════════
    async click6() {
        let _expHs6 = _listWindowHwnds('Medflow Clinical System');
        if (!_expHs6.length) {
            const _expTail6 = 'Medflow Clinical System'.split(' - ').pop();
            if (_expTail6 !== 'Medflow Clinical System') _expHs6 = _listWindowHwnds(_expTail6);
        }
        const _expHwnd6 = _expHs6.find(h => h === osForegroundHwnd()) || _expHs6[0] || _liveHwnd("Medflow Clinical System", _hwndCache[_mainTitleFrag]);
        osExpandCollapse(_expHwnd6, {"automationId":"facilitySelect","className":"","name":""}, null, null, null);
    }


    // ════════════════════════════════════════════════════════════
    // [W3] Medflow Clinical System (new window)
    // ════════════════════════════════════════════════════════════
    async click7() {
        osScopedInvoke(_liveHwnd("Medflow Clinical System", _hwndCache[_mainTitleFrag]), {"automationId":"","className":"","name":"TC2","controlTypeId":50007}, null, null, null, null, true);
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click8() {
        let _expHs8 = _listWindowHwnds('Medflow Clinical System');
        if (!_expHs8.length) {
            const _expTail8 = 'Medflow Clinical System'.split(' - ').pop();
            if (_expTail8 !== 'Medflow Clinical System') _expHs8 = _listWindowHwnds(_expTail8);
        }
        const _expHwnd8 = _expHs8.find(h => h === osForegroundHwnd()) || _expHs8[0] || _liveHwnd("Medflow Clinical System", _hwndCache[_mainTitleFrag]);
        osExpandCollapse(_expHwnd8, {"automationId":"deptSelect","className":"","name":""}, null, null, null);
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click11() {
        await _clickScoped('Medflow Clinical System', '~1', false, 50000);
    }
}
...
async function run() {
    ...
    console.log(`[session] Root session ${_rootSid} ready`);
        ...
        const page = new MockGoldenMedflowDropdownPageById();
    ...
    // [W2] Medflow Clinical System (new window)
    // ════════════════════════════════════════════════════════════
            await _step('6:expandCollapse ', () => page.click6());

    // ════════════════════════════════════════════════════════════
    // [W3] Medflow Clinical System (new window)
    // ════════════════════════════════════════════════════════════
            await _step('7:doubleClick TC2', () => page.click7());

    // ════════════════════════════════════════════════════════════
    // [W4] Medflow Clinical System (new window)
    // ════════════════════════════════════════════════════════════
            await _step('8:expandCollapse ', () => page.click8());

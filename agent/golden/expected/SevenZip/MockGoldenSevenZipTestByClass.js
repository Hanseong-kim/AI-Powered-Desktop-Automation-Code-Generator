...
class MockGoldenSevenZipPageByClass {
    async click6() {
...
async function run() {
    ...
    await initAppHwnd();
    normalizeWindowSimple({"left":1958,"top":144,"width":748,"height":690});

        const page = new MockGoldenSevenZipPageByClass();
            osActivate("7-Zip");

    // ════════════════════════════════════════════════════════════
    // [W1] 7-Zip (main window)
    // ════════════════════════════════════════════════════════════
            // [STEP 1] skip type on non-editable element
            // [STEP 2] skip type on non-editable element
            // [STEP 3] skip type on non-editable element
            // [STEP 4] skip type on non-editable element
            // [STEP 5] skip type on non-editable element
            await _step('6:click 컴퓨터', () => page.click6());
            // [STEP 7] skip type on non-editable element
            await _step('8:click C:', () => page.click8());
            // [STEP 9] skip type on non-editable element
            // [STEP 10] skip type on non-editable element
            // [STEP 11] skip type on non-editable element
            // [STEP 12] skip type on non-editable element
            // [STEP 13] skip type on non-editable element
            // [STEP 14] skip type on non-editable element
            // [STEP 15] skip type on non-editable element
            // [STEP 16] skip type on non-editable element
            // [STEP 17] skip type on non-editable element
    ...
    // ════════════════════════════════════════════════════════════
            ...
            // [STEP 24] skip type on non-editable element
            ...
            // [STEP 35] skip type on non-editable element
            ...
            // [STEP 52] skip type on non-editable element
            await _step('53:click ', () => page.click53());
            await _step('54:click ', () => page.click54());
            // [STEP 55] skip type on non-editable element
            // [STEP 56] skip type on non-editable element
            // [STEP 57] skip type on non-editable element
            // [STEP 58] skip type on non-editable element
            // [STEP 59] skip type on non-editable element
            // [STEP 60] skip type on non-editable element
            // [STEP 61] skip type on non-editable element
            await _step('62:doubleClick C:', () => page.click62());
            await _step('63:doubleClick $Recycle.Bin', () => page.click63());
            // [STEP 64] skip type on non-editable element
            // [STEP 65] skip type on non-editable element
            // [STEP 66] skip type on non-editable element

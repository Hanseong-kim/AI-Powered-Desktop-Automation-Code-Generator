...
class FileZillaPageByClass {
    ...
    async click13() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"고급"}, null, 62, null);
    }

    async click14() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"전송 설정"}, null, 61, null);
    }

    async click15() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"문자셋"}, null, 51, null);
    }

    async click16() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"일반"}, null, 50, null);
    }
...
async function run() {
    ...
    // ════════════════════════════════════════════════════════════
            ...
            await _step('8:type asdf\n', () => page.type8('asdf\n'));
            await _step('9:click 호스트(H):', () => page.click9());
            await _step('10:type asdf', () => page.type10('asdf'));
            await _step('11:click 포트(P):', () => page.click11());
            await _step('12:type 1234', () => page.type12('1234'));
            await _step('13:click 고급 (cross-window)', () => page.click13());
            await _step('14:click 전송 설정 (cross-window)', () => page.click14());
            await _step('15:click 문자셋 (cross-window)', () => page.click15());
            await _step('16:click 일반 (cross-window)', () => page.click16());
            await _step('17:click 취소', () => page.click17());
            await _step('18:expandCollapse 북마크(B) -> 북마크 추가(A)...\tCtrl+B', () => page.click18());

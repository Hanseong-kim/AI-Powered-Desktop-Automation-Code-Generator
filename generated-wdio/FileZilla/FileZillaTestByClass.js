...
class FileZillaPageByClass {
    ...
    async click3() {
        await _clickScoped('방화벽 및 라우터 설정 마법사', '//Button[@ClassName="Button" and @Name="다음(N) >"]');
    }

    async click4() {
        await _clickScoped('방화벽 및 라우터 설정 마법사', '//RadioButton[@ClassName="Button" and @Name="다음의 IP 주소 사용:"]');
    }

    async click5() {
        await _clickScoped('방화벽 및 라우터 설정 마법사', '//RadioButton[@ClassName="Button" and @Name="다음의 URL로부터 외부 IP 주소 가져오기:"]');
    }

    async click6() {
        await _clickScoped('방화벽 및 라우터 설정 마법사', '//Edit[@ClassName="Edit" and @Name="이 기능은 라우터에 연동되지 않은 경우만 작동합니다. 그렇지 않으면 사용자의 내부 주소밖에\n알아내지 못합니다."]');
    }

    async type7(value) {
        const ok = await _typeScopedOrCom('방화벽 및 라우터 설정 마법사', '//Edit[@ClassName="Edit" and @Name="이 기능은 라우터에 연동되지 않은 경우만 작동합니다. 그렇지 않으면 사용자의 내부 주소밖에\n알아내지 못합니다."]', value);
        if (!ok) {
    ...
    async click9() {
        await _clickScoped('방화벽 및 라우터 설정 마법사', '//Button[@ClassName="Button" and @Name="< 이전(B)"]', true);
    }

    async click10() {
        await _clickScoped('방화벽 및 라우터 설정 마법사', '//Button[@ClassName="Button" and @Name="< 이전(B)"]');
    }

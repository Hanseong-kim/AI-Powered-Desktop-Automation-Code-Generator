...
class FileZillaPageByClass {
    ...
    async type17(value) {
        const ok = await _typeScopedOrCom('사이트 관리자', '//Edit[@ClassName="Edit" and @Name="기본 로컬 디렉터리(L):"]', value);
        if (!ok) {
    ...
    async type19(value) {
        const ok = await _typeScopedOrCom('사이트 관리자', '//Edit[@ClassName="Edit" and @Name="기본 원격 디렉터리(E):"]', value);
        if (!ok) {
    ...
    async click21() {
        await _clickScoped('사이트 관리자', '//RadioButton[@ClassName="Button" and @Name="능동형(A)"]');
    }

    async click22() {
        await _clickScoped('사이트 관리자', '//RadioButton[@ClassName="Button" and @Name="수동형(P)"]');
    }

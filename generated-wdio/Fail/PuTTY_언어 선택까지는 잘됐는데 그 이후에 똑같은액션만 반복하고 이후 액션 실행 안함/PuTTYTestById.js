...
class PuTTYPageById {
    ...
    async click3() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"ISO-8859-5:1999 (Latin/Cyrillic)"}, {"automationId":"DropDown","className":"","name":""});
    }
    ...
    async click5() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"SSH to proxy and use port forwarding"}, {"automationId":"DropDown","className":"","name":""});
    }
...
async function run() {
    ...
    // ════════════════════════════════════════════════════════════
            ...
            await _step('2:click Translation', () => page.click2());
            await _step('3:click ISO-8859-5:1999 (Latin/Cyrillic) (cross-window)', () => page.click3());
            await _step('4:click UTF-8 (cross-window)', () => page.click4());
            await _step('5:click SSH to proxy and use port forwarding (cross-window)', () => page.click5());
            await _step('6:click None (cross-window)', () => page.click6());

    // ════════════════════════════════════════════════════════════
    // [W2] PuTTY Configuration (new window)
    // ════════════════════════════════════════════════════════════
            await _step('7:click Cancel', () => page.click7());
    } finally {

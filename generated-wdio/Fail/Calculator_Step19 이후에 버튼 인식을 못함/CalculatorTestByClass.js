...
async function run() {
    ...
    normalizeWindowSimple({"left":1502,"top":0,"width":418,"height":675});
        ...
        const page = new CalculatorPageByClass();
            ...
            await _step('8:click 더하기', () => page.click8());
            await _step('9:click 3', () => page.click9());
            await _step('10:click 5', () => page.click10());
            await _step('11:click 7', () => page.click11());
            await _step('12:click 빼기', () => page.click12());
            await _step('13:click 9', () => page.click13());
            await _step('14:click 8', () => page.click14());
            await _step('15:click 5', () => page.click15());
            await _step('16:click 5', () => page.click16());
            await _step('17:click 일치', () => page.click17());
            await _step('18:click 나누기', () => page.click18());
            await _step('19:click 8', () => page.click19());
            await _step('20:click 공', () => page.click20());
            await _step('21:click 일치', () => page.click21());
            await _step('22:click 곱', () => page.click22());
            await _step('23:click 9', () => page.click23());

...
class VisualStudioPageById {

    // ════════════════════════════════════════════════════════════
    // [W1] Microsoft Visual Studio (관리자) (main window)
    // ════════════════════════════════════════════════════════════
    async click1() {
        await _clickScoped('Microsoft Visual Studio (관리자)', '//Text[@Name="C:\\"]', false, 50020);
    }
    ...
    async click3() {
        await _clickScoped('hansung - Microsoft Visual Studio (관리자)', '//MenuItem[@Name="파일"]', false, 50011);
    }
    ...
    async click5() {
        await _clickScoped('hansung - Microsoft Visual Studio (관리자)', '//MenuItem[@Name="보기"]', false, 50011);
    }
    ...
    async click7() {
        await _clickScoped('hansung - Microsoft Visual Studio (관리자)', '~Minimize', false, 50000);
    }
}
...
async function run() {
    ...
    console.log(`[session] Root session ${_rootSid} ready`);
        ...
        const page = new VisualStudioPageById();

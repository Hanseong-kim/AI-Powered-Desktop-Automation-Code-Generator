...
class VisualStudioPageByClass {
    async click1() {
        await _clickBySid(_appSid, null, '//Text[@ClassName="TextBlock" and @Name="새 프로젝트 만들기(_N)"]');
    }
    ...
    async click3() {
        await _clickBySid(_appSid, null, '//ComboBox[@ClassName="ComboBox" and @Name="언어 필터"]');
    }
    ...
    async click5() {
        await _clickBySid(_appSid, null, '//Text[@ClassName="TextBlock" and @Name="리포지토리 복제(_C)"]');
    }
...
async function run() {
    ...
    normalizeWindowSimple({"left":398,"top":174,"width":1125,"height":673});
        ...
        const page = new VisualStudioPageByClass();
            ...
            await _step('1:click 새 프로젝트 만들기(_N)', () => page.click1());
            await _step('2:expandCollapse 언어 필터', () => page.click2());
            await _step('3:click 언어 필터', () => page.click3());
            await _step('4:click 뒤로(_B)', () => page.click4());
            await _step('5:click 리포지토리 복제(_C)', () => page.click5());

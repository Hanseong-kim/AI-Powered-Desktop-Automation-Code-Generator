...
class CalculatorPageByClass {
    async click1() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="7"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click2() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="8"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click3() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="9"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click4() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="곱"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click5() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="6"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click6() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="5"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click7() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="4"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click8() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="나누기"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click9() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="1"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click10() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="2"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click11() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="3"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {
    ...
    async click12() {
        try {
            const el = await browser.$('//*[@ClassName="Button" and @Name="일치"]');
            await el.waitForExist({ timeout: 8000 });
            await el.click();
        } catch (e) {

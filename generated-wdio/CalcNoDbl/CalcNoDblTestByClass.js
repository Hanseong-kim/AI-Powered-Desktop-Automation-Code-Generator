...
class CalcNoDblPageByClass {
    ...
    async click4() {
        await _clickBySid(_appSid, null, '//Button[@ClassName="Button" and @Name="빼기"]');
    }
    ...
    async click26() {
        await _clickBySid(_appSid, null, '//Button[@ClassName="Button" and @Name="4"]');
    }
    ...
    async click28() {
        await _clickBySid(_appSid, null, '//Button[@ClassName="Button" and @Name="2"]');
    }
...
async function run() {
    ...
    normalizeWindowSimple({"left":1502,"top":0,"width":418,"height":675});
        ...
        const page = new CalcNoDblPageByClass();
            osActivate("계산기");
            await _step('1:click 7', () => page.click1());
            await _step('2:click 8', () => page.click2());
            await _step('3:click 9', () => page.click3());
            await _step('4:click 빼기', () => page.click4());
            await _step('5:click 6', () => page.click5());
            await _step('6:click 8', () => page.click6());
            await _step('7:click 9', () => page.click7());
            await _step('8:click 일치', () => page.click8());
            await _step('9:click 곱', () => page.click9());
            await _step('10:click 9', () => page.click10());
            // [STEP 11] drag scope-out — replay skipped (event scope: Click/Type/DoubleClick/Scroll, 2026-07-10)
            await _step('12:click 7', () => page.click12());
            await _step('13:click 일치', () => page.click13());
            await _step('14:click 더하기', () => page.click14());
            await _step('15:click 6', () => page.click15());
            await _step('16:click 5', () => page.click16());
            await _step('17:click 일치', () => page.click17());
            await _step('18:click 곱', () => page.click18());
            await _step('19:click 1', () => page.click19());
            await _step('20:click 공', () => page.click20());
            await _step('21:click 공', () => page.click21());
            await _step('22:click 공', () => page.click22());
            await _step('23:click 공', () => page.click23());
            await _step('24:click 일치', () => page.click24());
            await _step('25:click 더하기', () => page.click25());
            await _step('26:click 4', () => page.click26());
            await _step('27:click 3', () => page.click27());
            await _step('28:click 2', () => page.click28());
            await _step('29:click 일치', () => page.click29());
    } finally {

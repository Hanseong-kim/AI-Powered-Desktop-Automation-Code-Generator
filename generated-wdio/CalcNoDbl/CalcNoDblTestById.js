...
class CalcNoDblPageById {
    ...
    async click4() {
        await _clickBySid(_appSid, null, '~minusButton');
    }
    ...
    async click19() {
        await _clickBySid(_appSid, null, '~num1Button');
    }

    async click20() {
        await _clickBySid(_appSid, null, '~num0Button');
    }
    ...
    async click26() {
        await _clickBySid(_appSid, null, '~num4Button');
    }
...
async function run() {
    ...
    normalizeWindowSimple({"left":1502,"top":0,"width":418,"height":675});
        ...
        const page = new CalcNoDblPageById();
            osActivate("계산기");

...
class PuTTYPageById {
    ...
    // ════════════════════════════════════════════════════════════
    async click2() {
        await _clickBySid(_appSid, null, '//RadioButton[@AutomationId="1045" and @Name="Printable output"]');
    }

    async click3() {
        await _clickBySid(_appSid, null, '~1047');
    }

    async click4() {
        await _clickBySid(_appSid, null, '//RadioButton[@AutomationId="1046" and @Name="All session output"]');
    }

    async click5() {
        await _clickBySid(_appSid, null, '~1048');
    }
    ...
    async click18() {
        await _clickBySid(_appSid, null, '~2');
    }
}

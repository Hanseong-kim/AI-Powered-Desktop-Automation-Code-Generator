...
class PuTTYPageByClass {
    ...
    async click11() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"Introduction to PuTTY"}, {"automationId":"1011","className":"Button","name":""}, 172, 522, "PuTTY User Manual");
    }

    async click12() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"Getting started with PuTTY"}, null, 186, null, "PuTTY User Manual");
    }

    async click13() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"Using PuTTY"}, null, 210, null, "PuTTY User Manual");
    }

    async click14() {
        await _clickBySid(_appSid, null, '//TreeItem[@Name="Telnet"]');
    }

    async click15() {
        await _clickBySid(_appSid, null, '//TreeItem[@Name="Rlogin"]');
    }

    async click16() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"닫기"}, {"automationId":"1010","className":"Button","name":""}, 14, 526, "About PuTTY");
    }

    async click17() {
        await _clickBySid(_appSid, null, '//Button[@ClassName="Button" and @Name="Help"]');
    }
}
...
async function run() {
    ...
    // [W2] PuTTY Configuration (new window)
    // ════════════════════════════════════════════════════════════
            await _step('4:click Disable application cursor keys mode', () => page.click4());
            await _step('5:click Disable application keypad mode', () => page.click5());
            await _step('6:click Disable xterm-style mouse reporting', () => page.click6());
            await _step('7:click Disable application cursor keys mode', () => page.click7());
            await _step('8:click Disable application keypad mode', () => page.click8());
            await _step('9:click Disable xterm-style mouse reporting', () => page.click9());
            await _step('10:click Appearance', () => page.click10());
            await _step('11:click Introduction to PuTTY (cross-window)', () => page.click11());
            await _step('12:click Getting started with PuTTY (cross-window)', () => page.click12());
            await _step('13:click Using PuTTY (cross-window)', () => page.click13());
            await _step('14:click Telnet', () => page.click14());
            await _step('15:click Rlogin', () => page.click15());
            await _step('16:click 닫기 (cross-window)', () => page.click16());
            await _step('17:click Help', () => page.click17());
    } finally {

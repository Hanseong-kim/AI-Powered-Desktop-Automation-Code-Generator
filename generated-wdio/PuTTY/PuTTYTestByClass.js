...
class PuTTYPageByClass {
    ...
    // ════════════════════════════════════════════════════════════
    async click2() {
        await _clickBySid(_appSid, null, '//RadioButton[@ClassName="Button" and @Name="Printable output"]');
    }

    async click3() {
        await _clickBySid(_appSid, null, '//RadioButton[@ClassName="Button" and @Name="SSH packets"]');
    }

    async click4() {
        await _clickBySid(_appSid, null, '//RadioButton[@ClassName="Button" and @Name="All session output"]');
    }

    async click5() {
        await _clickBySid(_appSid, null, '//RadioButton[@ClassName="Button" and @Name="SSH packets and raw data"]');
    }

    async click6() {
        osScopedInvoke(_appHwnd, {"automationId":"1057","className":"Button","name":"Flush log file frequently"}, null, null, null, "PuTTY Configuration", false, true);
    }
    ...
    async click9() {
        osScopedInvoke(_appHwnd, {"automationId":"1043","className":"Button","name":"Disable application cursor keys mode"}, null, null, null, "PuTTY Configuration", false, true);
    }

    async click10() {
        osScopedInvoke(_appHwnd, {"automationId":"1044","className":"Button","name":"Disable application keypad mode"}, null, null, null, "PuTTY Configuration", false, true);
    }

    async click11() {
        osScopedInvoke(_appHwnd, {"automationId":"1045","className":"Button","name":"Disable xterm-style mouse reporting"}, null, null, null, "PuTTY Configuration", false, true);
    }

    async click12() {
        osScopedInvoke(_appHwnd, {"automationId":"1046","className":"Button","name":"Disable remote-controlled terminal resizing"}, null, null, null, "PuTTY Configuration", false, true);
    }
    ...
    async click15() {
        await _clickBySid(_appSid, null, '~1042');
    }
...
async function run() {
    ...
    // [W2] PuTTY Configuration (new window)
    // ════════════════════════════════════════════════════════════
            await _step('2:click Printable output', () => page.click2());
            await _step('3:click SSH packets', () => page.click3());
            await _step('4:click All session output', () => page.click4());
            await _step('5:click SSH packets and raw data', () => page.click5());
            await _step('6:click Flush log file frequently', () => page.click6());
            await _step('7:click Flush log file frequently', () => page.click7());
            await _step('8:click Features', () => page.click8());
            await _step('9:click Disable application cursor keys mode', () => page.click9());
            await _step('10:click Disable application keypad mode', () => page.click10());
            await _step('11:click Disable xterm-style mouse reporting', () => page.click11());
            await _step('12:click Disable remote-controlled terminal resizing', () => page.click12());
            await _step('13:click Disable application cursor keys mode', () => page.click13());
            await _step('14:click Disable application keypad mode', () => page.click14());
            await _step('15:click ', () => page.click15());
            await _step('16:click Disable xterm-style mouse reporting', () => page.click16());
            await _step('17:click Disable remote-controlled terminal resizing', () => page.click17());
            await _step('18:click Cancel', () => page.click18());
    } finally {

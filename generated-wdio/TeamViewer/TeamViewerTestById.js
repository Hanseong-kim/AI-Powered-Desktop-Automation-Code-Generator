...
class TeamViewerPageById {
    ...
    // ════════════════════════════════════════════════════════════
    async click4() {
        await _clickScoped('TeamViewer', '//Window[@Name="TeamViewer"]');
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click6() {
        await _clickScoped('빠른 연결 허용', '~1125');
    }

    async type7(value) {
        const ok = await _typeScopedOrCom('빠른 연결 허용', '~1125', value);
        if (!ok) {
    ...
    async click8() {
        await _clickScoped('빠른 연결 허용', '~1126');
    }

    async type9(value) {
        const ok = await _typeScopedOrCom('빠른 연결 허용', '~1126', value);
        if (!ok) {
    ...
    // ════════════════════════════════════════════════════════════
    async click11() {
        await _clickScoped('오류', '//Window[@Name="오류"]');
    }
    ...
    async click13() {
        await _clickScoped('TeamViewer', '//*[@ClassName="View"]');
    }
}
...
async function run() {
    ...
    console.log(`[session] Root session ${_rootSid} ready`);
        ...
        const page = new TeamViewerPageById();

...
// being there.
async function _typeVerified(sid, rootElId, hwnd, selector, text) {
    return await _typeScopedOrCom(_appName || '', selector, text);
}
...
//   [W1] "컴퓨터\\" (main)
//   [W2] "C:\\Windows\\Vss\\" (opened during recording)
//   [W3] "7-Zip" (opened during recording)
//   [W4] "C:\\Windows\\Vss\\" (opened during recording)
//   [W5] "7-Zip" (opened during recording)
//   [W6] "7-Zip" (opened during recording)
//   [W7] "7-Zip" (opened during recording)

class SevenZipPageById {

    // ════════════════════════════════════════════════════════════
    // [W1] 컴퓨터\\ (main window)
    // ════════════════════════════════════════════════════════════
    async click1() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"컴퓨터"}, null, null, null, null, true);
    }

    async click2() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"C:"}, null, null, null, null, true);
    }

    async click3() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"Windows"}, null, null, null, null, true);
    }


    // ════════════════════════════════════════════════════════════
    // [W2] C:\\Windows\\Vss\\ (new window)
    // ════════════════════════════════════════════════════════════
    async click4() {
        await _clickScoped('C:\\Windows\\Vss\\', '~1001', true);
    }

    async click5() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"Writers"}, null, null, null, null, true);
    }

    async click6() {
        osScopedInvoke(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"System"}, null, null, null, null, true);
    }

    async click7() {
        await _clickScoped('C:\\Windows\\Vss\\', '~1002', true);
    }

    async click8() {
        await _clickScoped('C:\\Windows\\Vss\\', '~1002');
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click12() {
        osExpandCollapse(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"파일(F)"}, null, null, null);
    }


    // ════════════════════════════════════════════════════════════
    // [W4] C:\\Windows\\Vss\\ (new window)
    // ════════════════════════════════════════════════════════════
    async click13() {
        await _clickScoped('C:\\Windows\\Vss\\', '~1001');
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click14() {
        osExpandCollapse(_hwndCache[_mainTitleFrag], {"automationId":"","className":"","name":"파일(F)"}, null, 1, 21);
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click15() {
        await _clickScoped('7-Zip', '~2');
    }

    async click16() {
        await _clickScoped('7-Zip', '//Button[@Name="압축 풀기"]');
    }
...
async function run() {
    ...
    _mainTitleFrag = "컴퓨터\\";
    _dialogRects = {"컴퓨터\\":{"left":982,"top":36,"width":935,"height":863},"C:\\Windows\\Vss\\":{"left":982,"top":36,"width":935,"height":863},"7-Zip":{"left":982,"top":36,"width":935,"height":863}};
    await ensureAppium();
    _rootSid = await _createSession('Root');
    console.log(`[session] Root session ${_rootSid} ready`);
        await launchApp("C:\\Program Files\\7-Zip\\7zFM.exe", [], "컴퓨터\\", {"left":982,"top":36,"width":935,"height":863});

        const page = new SevenZipPageById();
    ...
    // ════════════════════════════════════════════════════════════
            ...
            await _step('3:doubleClick Windows', () => page.click3());

    // ════════════════════════════════════════════════════════════
    // [W2] C:\\Windows\\Vss\\ (new window)
    // ════════════════════════════════════════════════════════════
            await _step('switch to window: C:\\Windows\\Vss\\', async () => { await _switchWindow('C:\\Windows\\Vss\\'); osActivate('C:\\Windows\\Vss\\', _hwndCache['C:\\Windows\\Vss\\']); });
            await _step('4:doubleClick ', () => page.click4());
            await _step('5:doubleClick Writers', () => page.click5());
            await _step('6:doubleClick System', () => page.click6());
            await _step('7:doubleClick ', () => page.click7());
            await _step('8:click ', () => page.click8());
            await _step('9:doubleClick ', () => page.click9());
    ...
    // [W3] 7-Zip (new window)
    // ════════════════════════════════════════════════════════════
            await _step('12:expandCollapse 파일(F)', () => page.click12());
    ...
    // [W5] 7-Zip (new window)
    // ════════════════════════════════════════════════════════════
            await _step('14:select item #1 내부 열기(I)\tCtrl+PgDn', () => page.click14());

    // ════════════════════════════════════════════════════════════
    // [W6] 7-Zip (new window)
    // ════════════════════════════════════════════════════════════
            await _step('switch to window: 7-Zip', async () => { await _switchWindow('7-Zip'); osActivate('7-Zip', _hwndCache['7-Zip']); });
            await _step('15:click 확인', () => page.click15());
            await _step('16:click 압축 풀기', () => page.click16());

    // ════════════════════════════════════════════════════════════
    // [W7] 7-Zip (new window)
    // ════════════════════════════════════════════════════════════
            await _step('switch to window: 7-Zip', async () => { await _switchWindow('7-Zip'); osActivate('7-Zip', _hwndCache['7-Zip']); });
            await _step('17:click 확인', () => page.click17());
    } finally {

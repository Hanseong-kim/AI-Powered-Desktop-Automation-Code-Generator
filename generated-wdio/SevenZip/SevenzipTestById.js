...
class SevenZipPageById {
    ...
    // ════════════════════════════════════════════════════════════
    async click1() {
        osExpandCollapse(_appHwnd, {"automationId":"","className":"","name":"도구(T)"}, "옵션(P)...");
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click2() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"폴더"});
    }

    async click3() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"언어"});
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click4() {
        osScopedInvoke(_appHwnd, {"automationId":"2","className":"Button","name":""});
    }
}
...
async function run() {
    ...
    await initAppHwnd();
    normalizeWindowSimple({"left":2370,"top":-415,"width":1152,"height":592});
    ...
    // [W1] 7-Zip (main window)
    // ════════════════════════════════════════════════════════════
            await _step('1:expandCollapse 도구(T) -> 옵션(P)...', () => page.click1());

    // ════════════════════════════════════════════════════════════
    // [W2] 옵션 (new window)
    // ════════════════════════════════════════════════════════════
            await _step('2:click 폴더 (cross-window)', () => page.click2());
            await _step('3:click 언어 (cross-window)', () => page.click3());

    // ════════════════════════════════════════════════════════════
    // [W3] 옵션 (new window)
    // ════════════════════════════════════════════════════════════
            await _step('4:click 취소 (cross-window)', () => page.click4());
    } finally {

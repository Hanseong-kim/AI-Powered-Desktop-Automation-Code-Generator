...
//   [W1] "7-Zip" (main)
//   [W2] "C:\\hansung\\" (opened during recording)
...
class SevenZipPageById {
    ...
    // ════════════════════════════════════════════════════════════
    async click1() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"컴퓨터"}, null, null, null, null, true);
    }
    ...
    // ════════════════════════════════════════════════════════════
    // [W2] C:\\hansung\\ (new window)
    // ════════════════════════════════════════════════════════════
    async click3() {
        await _clickBySid(_appSid, null, '~1001', true);
    }

    async click4() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":".code-review-graph"}, null, null, null, null, true);
    }
...
async function run() {
    ...
    await initAppHwnd();
    normalizeWindowSimple({"left":985,"top":157,"width":935,"height":863});
    ...
    // ════════════════════════════════════════════════════════════
            ...
            await _step('2:doubleClick $Recycle.Bin', () => page.click2());

    // ════════════════════════════════════════════════════════════
    // [W2] C:\\hansung\\ (new window)
    // ════════════════════════════════════════════════════════════
            await _step('3:doubleClick ', () => page.click3());
            await _step('4:doubleClick .code-review-graph', () => page.click4());
            await _step('5:doubleClick ', () => page.click5());
            await _step('6:click ', () => page.click6());
            await _step('7:click ', () => page.click7());
    } finally {

...
//   [W1] "7-Zip" (main)
//   [W2] "7-Zip" (opened during recording)
...
class SevenZipPageById {
    ...
    // ════════════════════════════════════════════════════════════
    async click1() {
        osExpandCollapse(_appHwnd, {"automationId":"","className":"","name":"파일(F)"}, null, null, null);
    }
    ...
    async click5() {
        osExpandCollapse(_appHwnd, {"automationId":"","className":"","name":"보기(V)"}, null, null, null);
    }
    ...
    async click7() {
        osExpandCollapse(_appHwnd, {"automationId":"","className":"","name":"즐겨찾기(A)"}, null, null, null);
    }
    ...
    async click9() {
        osExpandCollapse(_appHwnd, {"automationId":"","className":"","name":"도구(T)"}, null, null, null);
    }
    ...
    async click11() {
        osExpandCollapse(_appHwnd, {"automationId":"","className":"","name":"도움말(H)"}, null, null, null);
    }
    ...
    async click13() {
        await _clickBySid(_appSid, null, '//Edit[@Name="컴퓨터"]');
    }

    async click15() {
        await _clickBySid(_appSid, null, '//Edit[@Name="C:"]');
    }

    async click17() {
        await _clickBySid(_appSid, null, '//Edit[@Name="Config.Msi"]');
    }
    ...
    async click20() {
        await _clickBySid(_appSid, null, '//Edit[@Name="hansung"]');
    }

    async click22() {
        await _clickBySid(_appSid, null, '//Edit[@Name="project"]');
    }

    async click24() {
        await _clickBySid(_appSid, null, '//Edit[@Name=".code-review-graph"]');
    }
    ...
    async click27() {
        await _clickBySid(_appSid, null, '//Edit[@Name="code-generator"]');
    }
    ...
    async click33() {
        await _clickBySid(_appSid, null, '//Button[@Name="닫기"]');
    }
}
...
async function run() {
    ...
    await ensureAppium();
    _appSid = await _createSession("C:\\\\Program Files\\\\7-Zip\\\\7zFM.exe");
    console.log(`[session] app session ${_appSid} ready`);
    await initAppHwnd();
    normalizeWindowSimple({"left":2914,"top":255,"width":748,"height":690});
    ...
    // ════════════════════════════════════════════════════════════
            ...
            await _step('5:expandCollapse 보기(V)', () => page.click5());
            await _step('6:click ', () => page.click6());
            await _step('7:expandCollapse 즐겨찾기(A)', () => page.click7());
            await _step('8:click ', () => page.click8());
            await _step('9:expandCollapse 도구(T)', () => page.click9());
            await _step('10:click ', () => page.click10());
            await _step('11:expandCollapse 도움말(H)', () => page.click11());
            await _step('12:click ', () => page.click12());
            await _step('13:click 컴퓨터', () => page.click13());
            // [STEP 14] skip type on non-editable element
            await _step('15:click C:', () => page.click15());
            // [STEP 16] skip type on non-editable element
            await _step('17:click Config.Msi', () => page.click17());
            // [STEP 18] skip type on non-editable element
            await _step('19:click ', () => page.click19());
            await _step('20:click hansung', () => page.click20());
            // [STEP 21] skip type on non-editable element
            await _step('22:click project', () => page.click22());
            // [STEP 23] skip type on non-editable element
            await _step('24:click .code-review-graph', () => page.click24());
            // [STEP 25] skip type on non-editable element
            await _step('26:click ', () => page.click26());
            await _step('27:click code-generator', () => page.click27());
            // [STEP 28] skip type on non-editable element
            await _step('29:click ', () => page.click29());
            await _step('30:doubleClick ', () => page.click30());
            await _step('31:click ', () => page.click31());
            await _step('32:click ', () => page.click32());
            await _step('33:click 닫기', () => page.click33());
    } finally {

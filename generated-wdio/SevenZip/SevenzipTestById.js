...
class SevenZipPageById {
    ...
    async click3() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"hansung"});
    }

    async click4() {
        osScopedInvoke(_appHwnd, {"automationId":"","className":"","name":"west"});
    }
}

describe('SevenZipTestById', () => {
    beforeAll(async () => {
        _warmupPowerShell();
        await initAppHwnd();
        normalizeWindowSimple({"left":32,"top":32,"width":1440,"height":740});
    });
    ...
    it('should replay recorded flow', async () => {
        const page = new SevenZipPageById();
            ...
            await _step('4:doubleClick west', () => page.click4());

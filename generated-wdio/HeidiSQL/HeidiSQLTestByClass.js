...
class HeidiSQLPageByClass {
    ...
    // ════════════════════════════════════════════════════════════
    async click1() {
        await _clickScoped('HeidiSQL 12.20.0.7320 - 세션 관리자', '//SplitButton[@ClassName="TButton" and @Name="신규"]');
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click18() {
        await _clickScoped('환경 설정', '//CheckBox[@ClassName="TCheckBox" and @Name="파일로 SQL 로그 작성"]', true);
    }
    ...
    // ════════════════════════════════════════════════════════════
    async click26() {
        await _clickScoped('HeidiSQL 정보', '//Button[@ClassName="TButton" and @Name="닫기"]');
    }
}

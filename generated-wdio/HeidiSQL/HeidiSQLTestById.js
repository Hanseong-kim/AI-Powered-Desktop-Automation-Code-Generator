...
class HeidiSQLPageById {
    ...
    async click6() {
        await _clickBySid(_appSid, null, '//CheckBox[@Name="자격 증명 프롬프트"]');
    }

    async click7() {
        await _clickBySid(_appSid, null, '//Pane[@Name="MySQL on RDS"]');
    }
    ...
    async click9() {
        osExpandCollapse(_appHwnd, {"automationId":"","className":"TComboBox","name":""}, "취소");
    }
}

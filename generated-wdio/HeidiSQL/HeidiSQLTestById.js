...
class HeidiSQLPageById {
    async click1() {
        await _clickBySid(_appSid, null, '//SplitButton[@Name="신규"]');
    }
    ...
    async click3() {
        await _clickBySid(_appSid, null, '//TabItem[@Name="고급"]');
    }
    ...
    async click5() {
        await _clickBySid(_appSid, null, '//TabItem[@Name="통계"]');
    }
}
...
async function run() {
    ...
    await initAppHwnd();
    normalizeWindowSimple({"left":797,"top":144,"width":875,"height":612});

        const page = new HeidiSQLPageById();
            osActivate("HeidiSQL 12.20.0.7320 - 세션 관리자");
            await _step('1:click 신규', () => page.click1());
            await _step('2:click SSH 터널', () => page.click2());
            await _step('3:click 고급', () => page.click3());
            await _step('4:click 설정', () => page.click4());
            await _step('5:click 통계', () => page.click5());
    } finally {
